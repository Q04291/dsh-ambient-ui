...
export const EMPTY_TRAIL_COUNTS: TrailCounts = { think: 0, tool: 0, output: 0 }
...
export function deriveChatActivity(snapshot: AmbientChatSnapshot): TrailActivity {
...
export function countDeltas(prev: TrailCounts, next: TrailCounts): TrailKind[] {
...
export function streamKind(activity: TrailActivity): TrailKind {
